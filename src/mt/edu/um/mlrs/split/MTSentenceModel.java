...
public class MTSentenceModel extends HeuristicSentenceModel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8268714321003765815L;

	public MTSentenceModel() {
		this(false, false);
	}

	public MTSentenceModel(boolean forceFinaltoken, boolean balanceParens) {
		super(MTSentenceModel.POSSIBLE_STOPS,
				MTSentenceModel.IMPOSSIBLE_PENULTIMATES,
				MTSentenceModel.IMPOSSIBLE_STARTS, forceFinaltoken,
				balanceParens);
	}
	...
	static {
		// Copied over from com.aliasi.sentences.IndoEuropeanSentenceModel
		POSSIBLE_STOPS.add(".");
		...
		POSSIBLE_STOPS.add(">>"); // french close quote
		POSSIBLE_STOPS.add("..."); // sloppy ellipsis
		POSSIBLE_STOPS.add("\u2026"); // ellipsis
	}
	...
	static {
		...
		// Maltese single letters
		IMPOSSIBLE_PENULTIMATES.add("Ġ");
		IMPOSSIBLE_PENULTIMATES.add("Ħ");
		IMPOSSIBLE_PENULTIMATES.add("Ż");
		IMPOSSIBLE_PENULTIMATES.add("Ċ");
		...
		// corporate designators
		// source:
		// http://www.ldc.upenn.edu/Catalog/CatalogList/LDC2001T02/resources.corp-desigs-ref-list
		...
		// Additional Maltese Stuff
		IMPOSSIBLE_PENULTIMATES.add("Onor");
		IMPOSSIBLE_PENULTIMATES.add("Sra");
		IMPOSSIBLE_PENULTIMATES.add("Sa");
		IMPOSSIBLE_PENULTIMATES.add("nru");
		IMPOSSIBLE_PENULTIMATES.add("Nru");
		IMPOSSIBLE_PENULTIMATES.add("Fr");
		IMPOSSIBLE_PENULTIMATES.add("Dott");
		IMPOSSIBLE_PENULTIMATES.add("MTL");
		IMPOSSIBLE_PENULTIMATES.add("Lm");
		IMPOSSIBLE_PENULTIMATES.add("Eur");
		IMPOSSIBLE_PENULTIMATES.add("Mons");
	}

	private static final Set<String> IMPOSSIBLE_STARTS = new HashSet<String>();
	...
	static {
	 ...
	 static class Serializer extends AbstractExternalizable {
	        ...
	        final MTSentenceModel mModel;
	        public Serializer() {
	            this(null);
	        }
	        public Serializer(MTSentenceModel model) {
	            mModel = model;
	        }
